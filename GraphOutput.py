...
class NeuralNetwork:
    def __init__(self, input_size=16, hidden_layers=[16, 32, 64, 32], output_size=4):
...
def get_game_state(snake_position, fruit_position, snake_body, direction):
    ...
    if fruit_position[0] == snake_position[0] and fruit_position[1] - 10 == snake_position[1]:
    ...
    if fruit_position[0] == snake_position[0] + 10 and fruit_position[1] == snake_position[1]:
